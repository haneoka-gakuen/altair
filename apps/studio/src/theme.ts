...
export const parseStudioThemePreference = (value: string | null | undefined): StudioThemePreference =>
  STUDIO_THEME_PREFERENCES.includes(value as StudioThemePreference) ? (value as StudioThemePreference) : "light";

export const resolveStudioTheme = (
  preference: StudioThemePreference,
  devicePrefersDark: boolean,
): ResolvedStudioTheme => (preference === "system" ? (devicePrefersDark ? "dark" : "light") : preference);
